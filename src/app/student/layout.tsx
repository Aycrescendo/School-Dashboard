...
import { LayoutDashboard, FileText, Megaphone, LogOut, School, Menu, X } from "lucide-react";
      ...
      <main className="flex-1 overflow-y-auto w-full">
        <div className="bg-white shadow-sm px-4 lg:px-8 py-4 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base lg:text-lg font-semibold text-gray-700">Student Dashboard</h1>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[#800020] text-white flex items-center justify-center font-bold text-sm">S</div>
            <span className="text-sm text-gray-600 hidden sm:block">Student</span>
          </div>
        </div>
