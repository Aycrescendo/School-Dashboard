...
import { LayoutDashboard, FileText, MessageSquare, Megaphone, LogOut, School } from "lucide-react";
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="bg-white shadow-sm px-8 py-4 flex items-center justify-between">
          <h1 className="text-lg font-semibold text-gray-700">Parent Dashboard</h1>
